    ...
    <div className="header">
      <div style={{ display: "flex", flexDirection: "row", gap: 24 }}>
        ...
        >
          ...
          <span>
          Ik werk graag aan projecten die technologie en grafisch ontwerp combineren. <br />
          In mijn vrije tijd onderzoek ik graag geschiedenis en topografie,<br />
          Wat voor mij als grote inspiratiebronnen dienen <br /> <br />
          Momenteel studeer ik Communicatie en Multimedia Design<br />
          aan de Avans hogeschool Breda.  {" "}
            <br />
            <br />
